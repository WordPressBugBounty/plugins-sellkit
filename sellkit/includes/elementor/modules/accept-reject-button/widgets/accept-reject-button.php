...
class Sellkit_Elementor_Accept_Reject_Button_Widget extends Sellkit_Elementor_Upsell_Base_Widget {
	...
	public function get_title() {
		return esc_html__( 'Accept/Reject Button', 'sellkit' );
	}
	...
	protected function render() {
		...
		<div class="sellkit-accept-reject-button-widget">
			<a
				class="elementor-button sellkit-accept-reject-button <?php echo esc_attr( $button_type_class ); ?> elementor-size-<?php echo esc_attr( $settings['button_size'] ); ?>"
				data-order-key="<?php echo esc_attr( $order_key ); ?>"
			>
				<?php Icons_Manager::render_icon( $settings['selected_icon'] ); ?>
				<span class="sellkit-accept-reject-button-title" ><?php echo wp_kses_post( $settings['title'] ); ?></span>
				<br>
				<span class="sellkit-accept-reject-button-sub-title"><?php echo wp_kses_post( $settings['sub_title'] ); ?></span>
			</a>
