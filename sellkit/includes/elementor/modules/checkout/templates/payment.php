...
if ( ! wp_doing_ajax() ) {
	?>
		...
		<p class="sellkit-one-page-checkout-payment-desc sub-heading">
			<?php echo wp_kses_post( apply_filters( 'sellkit_core/widgets/checkout/custom_message/secure_transaction_text', esc_html__( 'All transactions are secure and encrypted.', 'sellkit' ) ) ); ?>
		</p>
	<?php
}
if ( $is_editor ) {
