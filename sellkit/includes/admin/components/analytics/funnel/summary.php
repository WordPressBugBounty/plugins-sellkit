...
class Summary {
	...
	public function set_alert_details() {
		...
		$this->data['upsell_revenue']      = ! empty( $query_result[0]['upsell_revenue'] ) ? round( $query_result[0]['upsell_revenue'], 2 ) : 0;
		...
		$this->data['bounce_rate']         = ( ! empty( $bounce_rate ) && $bounce_rate > 0 ) ? floatval( number_format( $bounce_rate , 2 ) ) : 0;
