...
class Promote_Sellkit_Pro {
	...
	public function update_conditions_data( $conditions ) {
		...
		$pro_conditions = [
			...
			'purchased-product-quantity' => esc_html__( 'Purchased Product Count', 'sellkit' ),
			'purchased-product' => esc_html__( 'Purchased Products', 'sellkit' ),
			'cart-item-quantity' => esc_html__( 'Cart Item Count', 'sellkit' ),
			...
			'visitor-city' => esc_html__( 'Visitor City & Region', 'sellkit' ),
